...
{
	public class StormTornadoProjectileCharged : ModProjectile
	{
		private bool SpeedUp = false;
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("StormTornadoProjectileCharged");     //The English name of the Projectile
        ...
        public override void ModifyDamageHitbox(ref Rectangle hitbox)
        {
			...
			hitbox.X = hitbox.X - 50; //esquerda e direito
        ...
        public override void AI()
		{
			...
			//Projectile.position = new Vector2(player.position.X, player.position.Y);
