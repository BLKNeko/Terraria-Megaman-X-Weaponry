...
{
	public class ZSaberBlackProjectile : ModProjectile
	{
		private bool SpeedUp = false;
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("ZSaberBlackProjectile");     //The English name of the projectile
		...
		public override void AI()
		{
			...
			// Kill this projectile after 1,5 second
		...
		public override void Kill(int timeLeft)
		{
			...
			//Main.PlaySound(SoundID.Item, -1, -1, mod.GetSoundSlot(SoundType.Item, "Sounds/Item/ZSaberEnd"));
		}
	}
