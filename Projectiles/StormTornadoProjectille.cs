...
{
	public class StormTornadoProjectille : ModProjectile
	{
		private bool SpeedUp = false;
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("StormTornadoProjectille");     //The English name of the Projectile
		...
		public override void ModifyDamageHitbox(ref Rectangle hitbox)
		{
			...
			//hitbox.X = Main.ProjectileTexture[Projectile.type].Height / Main.projFrames[Projectile.type];

			//hitbox.X = hitbox.X - 40; //esquerda e direito
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
            ...
            {
				return Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), Projectile.Right,
				Projectile.Left + unit * Distance, 22, ref point);
			}
			else
            {
				return Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), Projectile.Left,
				Projectile.Right + unit * Distance, 22, ref point);
			}
