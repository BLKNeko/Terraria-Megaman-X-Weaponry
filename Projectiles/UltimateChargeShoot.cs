...
{
	public class UltimateChargeShoot : ModProjectile
	{
		private bool SpeedUp = false;
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("UltimateChargeShoot");     //The English name of the Projectile
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			Vector2 ZVelocity = new Vector2(0, 0);
			Vector2 TargetPosition = new Vector2(target.Center.X, target.Center.Y);

			//Projectile.NewProjectile(target.Center.X, target.Center.Y, 0, 0, base.mod.ProjectileType("PlasmaBolt"), (damage / 2), 0, player.whoAmI);

			Projectile.NewProjectile(entitySource, TargetPosition, ZVelocity, ModContent.ProjectileType<Projectiles.PlasmaBolt>(), (damage / 2 ), 0, player.whoAmI);
		}
