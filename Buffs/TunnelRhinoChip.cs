...
{
	public class TunnelRhinoChip : ModBuff
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("TornadoFangChip");
			Description.SetDefault("X fires a drill-shaped missile which delays for a moment before firing forward. \n Hold Right Mouse Button after using the charged ability extend the duration at cost of mana 10/s  \n Right Click to remove the effect");
