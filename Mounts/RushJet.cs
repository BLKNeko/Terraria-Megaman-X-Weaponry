...
namespace MegamanXWeaponry.Mounts
{
	public class RushJet : ModMount
	{
        ...
        public override void SetStaticDefaults()
        {
            ...
            MountData.flightTimeMax = 600; // The amount of time in frames a mount can be in the state of flying.

            // Misc
            MountData.fatigueMax = 0;
            MountData.buff = ModContent.BuffType<Buffs.RushJetBuff>(); // The ID number of the buff assigned to the mount.
