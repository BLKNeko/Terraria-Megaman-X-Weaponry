...
namespace MegamanXWeaponry.Items.Weapon
{
	public class MaxBuster : ModItem
	{
		...
		{
			base.DisplayName.SetDefault("MaxBuster");
			base.Tooltip.SetDefault("3rd generation advanced Hand Cannon that can [c/fca400:charge] energy for a powerfull shoot [c/3639bb: - Costs 1MP ] \nHold to [c/fca400:charge] a powerfull wide area special attack [c/3639bb: - Costs 15MP ]");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(mod.GetItem("XBuster"));
