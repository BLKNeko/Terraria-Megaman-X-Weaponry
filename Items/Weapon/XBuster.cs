...
namespace MegamanXWeaponry.Items.Weapon
{
    ...
    public class XBuster : ModItem
    {
        ...
        {
            base.DisplayName.SetDefault("X-Buster");
            base.Tooltip.SetDefault("Mega Buster Mark 17. Shoots bullets of compressed solar energy. Allows stockpiling of energy to release as a more powerful Charge Shot [c/3639bb: - Costs 1MP ] \nHold to [c/fca400:charge] a powerfull special attack [c/3639bb: - Costs 10MP ]");
        }
        ...
        public override bool AltFunctionUse(Player player)
        {
            ...
            if (SkillIndex == 0 && player.HasBuff(ModContent.BuffType<Buffs.ChillPenguinChip>()) && !ChangeIndex)
            {
                SkillIndex = 62;
                ChangeIndex = true;
            }
            if (SkillIndex == 0 && !player.HasBuff(ModContent.BuffType<Buffs.ChillPenguinChip>()) && player.HasBuff(ModContent.BuffType<Buffs.StormEagleChip>()) && !ChangeIndex)
            {
                SkillIndex = 37;
                ChangeIndex = true;
            }

            if(SkillIndex == 62 && player.HasBuff(ModContent.BuffType<Buffs.StormEagleChip>()) && !ChangeIndex)
            {
                SkillIndex = 37;
                ChangeIndex = true;
            }
        ...
        */
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if (charge > 0f)
            {
                ...
                //----------------------------------SHOTGUNICE----------------------------------------
                if (player.HasBuff(ModContent.BuffType<Buffs.ChillPenguinChip>()) && charge >= (float)(base.Item.useTime * 4.3f) && !alreadyFired && player.altFunctionUse != 2 && SkillIndex == 62)
                {
                    ...
                    {
                        SoundEngine.PlaySound(new SoundStyle("MegamanXWeaponry/Sounds/Item/ShotgunIceShoot")
                        {
                            Volume = 0.8f,
                            Pitch = 0.3f,
                            PitchVariance = 0.2f,
                        ...
                        Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<Projectiles.ShotgunIceCharged>(), damage * 3, knockback * 5, player.whoAmI);
                    }


                    alreadyFired = true;
                }
                else if (player.HasBuff(ModContent.BuffType<Buffs.ChillPenguinChip>()) && !alreadyFired && player.altFunctionUse != 2 && SkillIndex == 62)
                {
                    ...
                    if (player.statMana >= 19)
                    {
                        ...
                        Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<Projectiles.ShotgunIce>(), damage * 2, knockback * 2, player.whoAmI);
                    }
                ...
                //-------------------------------------STORMTORNADO------------------------------------------
                if (player.HasBuff(ModContent.BuffType<Buffs.StormEagleChip>()) && charge >= (float)(base.Item.useTime * 4.3f) && !alreadyFired && player.altFunctionUse != 2 && SkillIndex == 37)
                {
                    //base.item.mana = 10;
                    //ChargeLoop.LP = false;
                    if (player.statMana >= 29)
                    {
                        ...
                        Projectile.NewProjectile(source, position, new Vector2(0,0), ModContent.ProjectileType<Projectiles.StormTornadoProjectileCharged>(), damage * 3, knockback * 10, player.whoAmI);
                    }


                    alreadyFired = true;
                }
                else if (player.HasBuff(ModContent.BuffType<Buffs.StormEagleChip>()) && !alreadyFired && player.altFunctionUse != 2 && SkillIndex == 37)
                {
                    ...
                    if (player.statMana >= 19)
                    {
                        ...
                        SoundEngine.PlaySound(new SoundStyle("MegamanXWeaponry/Sounds/Item/StormTornadoSFX")
                        {
                            Volume = 0.5f,
                            Pitch = 0.5f,
                            PitchVariance = 0.3f,
                        ...
                        player.statMana -= 19;
                        Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<Projectiles.StormTornadoProjectille>(), damage, knockback * 8, player.whoAmI);
                    }
                ...
                if (charge >= (float)(Item.useTime * 4.3f) && !alreadyFired)
                {
                    ...
                    if (player.statMana >= 9)
                    {
                        ...
                        Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<Projectiles.XBulletC>(), damage * 4, knockback * 4, player.whoAmI);
                    }
